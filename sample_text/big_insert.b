...
abstract class DatabaseConnection extends PDO {
  ...
  /**
   * This is a test of what happens if google-diff-match-patch is asked to
   * add a relatively long, multi-line block to a file. Rumor has it that
   * at least some implementations of this patch algorithm require each
   * patch fragment to be no larger than 32 bytes. So we'll see what this
   * ends up doing.
   */
